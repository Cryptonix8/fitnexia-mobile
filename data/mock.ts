...
export const MOCK_INSTRUCTORS: Instructor[] = [
  {
    ...
    certifications: [
      { name: 'Certificación PTR', issuer: 'PTR', year: 2018 },
      { name: 'Psicología deportiva', issuer: 'ITF', year: 2020 },
    ],
  },
  {
    id: 'inst-2',
    ...
    disciplines: ['Yoga', 'Pilates suelo/reformer'],
    verified: true,
    availableNow: false,
    averageRating: 4.8,
    reviewCount: 89,
  ...
  },
  {
    ...
    bio: 'Especialista en entrenamiento de alta intensidad y fuerza.',
    disciplines: ['Entrenamiento Funcional', 'Entrenamiento cross'],
    verified: false,
    availableNow: false,
    averageRating: 4.6,
    reviewCount: 42,
...
export const MOCK_CLASSES: ClassListItem[] = [
  {
    ...
    location: { lat: -34.6, lng: -58.38, label: 'Sede FitHub — Sala A' },
    averageRating: 4.8,
  },
  {
    id: 'class-2',
  ...
  {
    id: 'class-4',
    title: 'Cross training grupal',
    discipline: 'Entrenamiento cross',
    modality: 'in_person',
    ...
    location: { lat: -34.6037, lng: -58.3816, label: 'Sede FitHub' },
    averageRating: 4.7,
  },
  {
    id: 'class-5',
    title: 'Pilates Nocturno',
    discipline: 'Pilates suelo/reformer',
    modality: 'in_person',
    ...
    location: { lat: -34.59, lng: -58.37, label: 'Espacio Wellness' },
    averageRating: 4.8,
  },
];
